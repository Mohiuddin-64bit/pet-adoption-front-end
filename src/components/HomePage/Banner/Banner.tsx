...
const Banner = () => {
  return (
    ...
    >
      <Image
        src="https://tailwag.progressionstudios.com/wp-content/uploads/2022/04/its-breakfast-time-dog-wrapped-in-a-blue-knitted-blanket-on-an-early-morning-sitting-at-the-table_t20_ZV4Gak.jpg"
        alt="banner"
        layout="fill"
        objectPosition="left"
        objectFit="cover"
      />
      <div
        className="absolute elementor-shape elementor-shape-bottom"
        data-negative="false"
      >
        <svg
